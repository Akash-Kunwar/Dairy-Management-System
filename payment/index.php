...
<form class=" form-inline" method="post" action="" style="margin:10px;">
    <div class="form-group">
        ...
        <input style="margin-left:20px;"type="submit" class="btn btn-info" value="Get Records">
    </div>
</form>
<table class="table table-hover table-striped table-condensed table-bordered" style="margin:10px">
