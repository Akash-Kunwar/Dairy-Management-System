...
if (isset($_GET['f_no'])) {
    ...
    <div id="printable">
        <table id="receipt"  >
            ...
            <th colspan="2"  ><h1>DFSM Payment Receipt</h1></th>
            </thead>
            <tbody>
                ...
                <tr><td><strong>Price Per Liter</strong></td><td> <?php echo $rate ?></td></tr>
                ...
                <tr><td><strong>Authorized by:</strong></td><td><?php echo 'DFSM'; ?></td></tr>
        </table>  
        <h3>Details</h3>
        <?php
        ...
        echo '</tbody></table>';
        echo '<h4>Total amount Rs:'. ($farmer_total * $rate) .'</h4>';
        ?>
    </div>
    <br/><br/>
