...
<form class=" form-inline" method="post" action="">
    <div class="form-group">
        ...
        <label style="margin-left:10px" class="control-label" for="to"> To Date :</label >
        ...
        <input style="margin-left:10px"type="search" name="farmer" class="search-query" value="" placeholder="Farmer No">
        <input style="margin-left:10px"type="submit" class="btn btn-info" value="Get Records">
    </div>
</form>
<div id="printable">
