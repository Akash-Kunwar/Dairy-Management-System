...
<a href='index.php' class='btn btn-primary'>Back To Listing</a>
    <form action='' method='POST' class="form-horizontal" > 
        <div class="form-group">
            <label class="" for="f_no">Farmer No:</label >
            <div class="controls">
            <input style="width:250px;"class="form-control" type="text" placeholder="**" name='f_no' value='<?php echo stripslashes($row['f_no']) ?>'/> 
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="f_id"> Aadhar No:</label >
            <div class="controls">
                <input style="width:250px;"class="form-control" type="text" placeholder="4816****" name='f_id' value='<?php echo stripslashes($row['f_id']) ?>'/> 
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="f_name"> Name of Farmer:</label >
            <div class="controls">
                <input style="width:250px;"class="form-control" type="text" placeholder="Name.." name='f_name' value='<?php echo stripslashes($row['f_name']) ?>'/> 
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="f_locallity"> Locality of Farmer:</label >
            <div class="controls">
                <input style="width:250px;"class="form-control" type="text" placeholder="Area-X.." name='f_locallity' value='<?php echo stripslashes($row['f_locallity']) ?>'/> 
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="f_ac"> Farmer's A/C NO:</label >
            <div class="controls">
                <input  style="width:250px;"class="form-control" type="text" placeholder="Bank account number ******.." maxlength="12" minlength="12"name='f_ac' value='<?php echo stripslashes($row['f_ac']) ?>' /> 
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="f_phone"> Farmer Phone NO:</label >
            <div class="controls">
                <input style="width:250px;"class="form-control" type="text" placeholder="******.." maxlength="10" minlength="10"name='f_phone'  value='<?php echo stripslashes($row['f_phone']) ?>' /> 
            </div>
        </div>
